...
// File: @gnosis.pm/conditional-tokens-market-makers/contracts/Whitelist.sol
...
// File: @gnosis.pm/conditional-tokens-market-makers/contracts/MarketMaker.sol
...
contract MarketMaker is Ownable, ERC1155TokenReceiver {
        ...
        returns (int netCost)
    {
        ...
        if (outcomeTokenNetCost > 0) {
            tradeVolume.add(uint(outcomeTokenNetCost));
        } else {
            tradeVolume.add(uint(-outcomeTokenNetCost));
        }
...
// File: @gnosis.pm/conditional-tokens-market-makers/contracts/LMSRMarketMaker.sol
...
// File: @gnosis.pm/conditional-tokens-market-makers/contracts/LMSRMarketMakerFactory.sol
...
// File: contracts/AppDependencies.sol
